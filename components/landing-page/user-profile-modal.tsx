    ...
    >
      <div className="mt-10 mr-10 bg-[#101213] rounded-[12px] px-[25px] py-[35px] border-[4px] border-[#292929] max-h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden">
        <div className="w-[341px] flex flex-col gap-[25px]">
          <div className="flex justify-between">
            <div className="flex gap-[15px] items-center">
              ...
              <div className="flex flex-col gap-[5px]">
                <div className="font-semibold text-[20px] font-sans">
                  Randy Inor
                </div>
          ...
          <div className="flex flex-col gap-[16px] h-[199px]">
            <div className="font-sans font-normal text-[14px] text-[#8E9BAE]">
              Connected Wallet
            </div>
            <div className="border-[1px] border-[#292929] [border-style:dashed] [stroke-dasharray:7,7]">
