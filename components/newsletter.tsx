...
const Newsletter: React.FC = () => {
  ...
  return (
    <div className="px-4 sm:px-14">
      <div className="mx-auto container bg-purple bg-cover rounded-[10px] sm:rounded-[3rem] text-white relative overflow-hidden h-auto md:h-[35vh] flex items-center px-4 sm:px-10 lg:px-[10rem] py-10 mb-4">
        {/* top star */}
        <Image
          src={stars}
          height={50}
        ...
        <div className="mx-auto w-full">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-[150px]">
            <div className="md:w-1/2 text-center md:text-left">
              <h2 className="text-[40px] sm:text-4xl lg:text-5xl font-bold mb-4">
                Stay in the loop
              </h2>
